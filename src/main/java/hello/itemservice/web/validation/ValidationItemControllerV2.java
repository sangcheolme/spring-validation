...
//    @PostMapping("/add")
    public String addItemV1(@ModelAttribute Item item,
        ...
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 1000000) {
            bindingResult.addError(new FieldError("item", "price", "가격은 1,000 ~ 1,000,000 사이 입니다."));
        }
...
//    @PostMapping("/add")
    public String addItemV2(@ModelAttribute Item item,
        ...
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 1000000) {
            bindingResult.addError(new FieldError("item", "price", item.getPrice(), false, null, null, "가격은 1,000 ~ 1,000,000 사이 입니다."));
        }
        if (item.getQuantity() == null || item.getQuantity() > 9999) {
